...
export const InfiniteMovingCards = ({
  ...
  function addAnimation() {
    if (containerRef.current && scrollerRef.current) {
      ...
      // Set direction and speed of the scroll animation
      getDirection();
      getSpeed();
      setStart(true);
    }
      ...
      >
        {items.map((item, idx) => (
          <li
            ...
            style={{
              background: "inherit", // Background inherits from parent
              borderColor: "inherit", // Border color inherits from parent
            }}
            key={idx}
          >
